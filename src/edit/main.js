...
const template = `<style>:host{display:block;position:relative;box-sizing:border-box;border:solid 1px var(--color-border);border-radius:2px;background:var(--color-background-card)}:host([disabled=true]){pointer-events:none;filter:grayscale(1);opacity:.4}:host([single=true]) .input{display:block}:host([single=true]) .field{display:none}.text{display:block;background:none;font-family:inherit;color:inherit;width:100%;word-break:break-word;padding:8px;line-height:1.4;outline:0;resize:none;scrollbar-width:none;font-size:1rem;border:0;box-sizing:border-box}.text::-webkit-scrollbar{display:none}.text::selection{background:rgba(var(--color-accent));color:#fff}.text::placeholder{color:var(--color-text-disabled)}.shadow{position:absolute!important;pointer-events:none!important;opacity:0!important;bottom:0!important;left:0!important}.input{display:none}</style><input type="text" class="text input" part="root"><textarea class="text shadow" part="root" style="height:0"></textarea><textarea class="text field" part="root"></textarea>`
