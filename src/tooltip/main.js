...
const template = `<style>:host{display:inline-block;vertical-align:middle}.root{z-index:3;display:block;user-select:none;position:fixed;left:0;top:0;background:rgba(97,97,97,.9);color:#fff;border-radius:2px;padding:6px 8px;font-size:.75rem;line-height:1.6;width:100%;max-width:112px;word-wrap:break-word;word-break:break-all;pointer-events:none;transform:scale(.9);filter:opacity(0);transition:transform .2s,filter .2s}@media(pointer:fine){:host(:hover) .root{transform:scale(1)!important;filter:opacity(1)!important}}@media(pointer:coarse){:host(:active) .root{transform:scale(1)!important;filter:opacity(1)!important}}</style><slot></slot><slot class="root" part="root" name="text"></slot>`
